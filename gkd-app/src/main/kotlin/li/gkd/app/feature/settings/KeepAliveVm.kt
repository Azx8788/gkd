...
class KeepAliveVm : BaseViewModel() {
    init {
    ...
    fun setStatusServiceEnabled(enabled: Boolean) {
        ServiceController.setStatusEnabled(enabled)
    }
    ...
    fun setKeepAliveOverlayEnabled(enabled: Boolean) {
        AppStore.updateSettings { it.copy(enableKeepAliveOverlay = enabled) }
    }

    fun setBootReviveEnabled(enabled: Boolean) {
        AppStore.updateSettings { it.copy(enableBootRevive = enabled) }
    }
}
